...
| TRN-14 | Hardware conservation: locomotives and carriages exist either in inventory or on exactly one line; deletion refunds everything ([NET-14](04-network-editing.md#edit-operations)). Total hardware never decreases. |
